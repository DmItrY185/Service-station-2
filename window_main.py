...
class WindowMain:
    def __init__(self, color_mode_, user):
        ...
        # self.services = ['Заміна тормозних барабанів   200грн.', 'Заміна тормозних дисків задніх/передніх   250грн.',
        #                  'Заміна тормозної рідини   200грн.', 'Заміна тормозного шлангу   80грн.',
        #                  'Заміна заднього/переднього суппорта   200грн.', 'Заміна колодок ручного тормозу   400грн.',
        #                  '', '         ТОРМОЗНА СИСТЕМА', '',
        #                  'Заміна топливного фільтра   80 грн.', 'Заміна масла у мосту   80грн.',
        #                  'Заміна масла двигуна   100грн.', 'Заміна масла в АКПП   2000грн.',
        #                  'Заміна масла в механічній КПП   200грн.', 'Заміна антифріза   400грн.',
        #                  '', '         ТЕХ. РІДИНИ, МАСЛА', '',
        #                  'Ремонт рульової рейки(заміна вала)   5000грн.',
        #                  'Ремонт рульової рейки   3000грн.', 'Зняття/встановлення рульової рейки   600грн.',
        #                  'Зняття і встановлення рульового механізму   600грн.', 'Заміна рульового редуктора
        #                  600грн.',
        #                  'Заміна пильника рульової рейки   100грн.', 'Заміна рідини гідропосилювача   120грн.',
        #                  '', '             РУЛЬОВА РЕЙКА', '',
        #                  'Заміна ременя ГРМ(дизель)   1200грн.', 'Заміна ременя ГРМ   800грн.',
        #                  'Заміна ременя генератора   120грн.', 'Заміна радіатора   600грн.',
        #                  'Заміна повітряного фільтра   80грн.', 'Діагностика топливної системи   120грн.',
        #                  'Діагностика системи трансмісії   100грн.', 'Діагностика системи охолодження   120грн.',
        #                  'Діагностика вихлопної системи   80грн.', 'Встановлення захисту картера двигуна   100грн.',
        #                  '', '                      ДВИГУН', '',
        #                  'Перевірка бензонасоса   250грн.', 'Заміна форсунок(бензинові)   160грн.',
        #                  'Заміна лампочок   20грн.', 'Заміна датчиків двигуна   100грн.',
        #                  'Заміна високовольтних дротів   150грн.', 'Заміна вентилятора охолодження   300грн.',
        #                  'Діагностика електрообладнання   200грн.', 'Генератор заміна, зняття/встановлення   250грн.',
        #                  'Встановлення противоугінних систем   600грн.', 'Встановлення аудіопристою   400грн.',
        #                  '', '               АВТОЕЛЕКТРИКА    ']
